...
z025_19_agg1 <- z025_19_agg[!z025_19_agg$`Plot Name` %in% c("M37W","M162W","Tx303","B73"),]
cor.test(z025_19_agg1$mean, z025_19_agg1$mummi_rate, method = "pearson") # 0.3259189 
cor.test(z025_19_agg1$mean, z025_19_agg1$incidence_rate, method = "pearson") # 0.8673955 
cor.test(z025_19_agg1$mummi_rate, z025_19_agg1$incidence_rate, method = "pearson") # 0.198947  
# all significant, but signidicant is not important

cor.test(z025_19_agg1$mean1, z025_19_agg1$mummi_rate1, method = "pearson") #0.314348  

cor.test(z025_19_agg1$mean, z025_19_agg1$severity_mean, method = "pearson") # 0.3738682  
cor.test(z025_19_agg1$incidence_rate, z025_19_agg1$severity_mean, method = "pearson") # 0.1040342 
...
tbbc3_19_1 %>% 
  mutate(coverage_rate1 = coverage_count/non_na_count) -> tbbc3_19_1
...
# combined mean with incidence
tbbc3_19_agg <- merge(x=tbbc3_19_1,y=tbbc3_19_incidence[,c(1,19)], by.x = "Plot", by.y = "Plot", all.x = TRUE, all.y = TRUE)
...
# remove the check lines and calculate the correlation coefficient
tbbc3_19_agg1 <- tbbc3_19_agg[!tbbc3_19_agg$`Plot Name` %in% checks,]
cor.test(tbbc3_19_agg1$mean, tbbc3_19_agg1$mummi_rate, method = "pearson") # 0.1254219 
cor.test(tbbc3_19_agg1$mean, tbbc3_19_agg1$incidence_rate, method = "pearson") # 0.8288525  
cor.test(tbbc3_19_agg1$mummi_rate, tbbc3_19_agg1$incidence_rate, method = "pearson") #0.08670571   
# all significant, but signidicant is not important

cor.test(tbbc3_19_agg1$mean1, tbbc3_19_agg1$mummi_rate1, method = "pearson") # 0.1322685   

cor.test(tbbc3_19_agg1$mean, tbbc3_19_agg1$severity_mean, method = "pearson") # 0.2392464   
# there is some correlation between the coverage and severity for eacg plot
```
...
```{r}
write.csv(tbbc3_18_agg, "/Users/qiuyuting/Documents/data_file/tbbc3_18_agg1.csv")
write.csv(z025_19_agg1, "/Users/qiuyuting/Documents/data_file/z025_19_agg1.csv")
write.csv(tbbc3_19_agg1, "/Users/qiuyuting/Documents/data_file/tbbc3_19_agg1.csv")
```
