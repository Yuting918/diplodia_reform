...
cor.test(tbbc3_19_agg1$mean, tbbc3_19_agg1$mummi_rate, method = "pearson") # 0.09024929 
cor.test(tbbc3_19_agg1$mean, tbbc3_19_agg1$incidence_rate, method = "pearson") # 0.8282704  
cor.test(tbbc3_19_agg1$mummi_rate, tbbc3_19_agg1$incidence_rate, method = "pearson") #0.04993093   
# all significant, but signidicant is not important

cor.test(tbbc3_19_agg1$mean1, tbbc3_19_agg1$mummi_rate1, method = "pearson") # 0.1243563   

cor.test(tbbc3_19_agg1$mean, tbbc3_19_agg1$severity_mean, method = "pearson") # 0.2322353   
# there is some correlation between the coverage and severity for eacg plot
```
